...
class Hackathon(models.Model):
    ...
    name = models.CharField(
        max_length=40, blank=True, null=True, verbose_name=_("name")
    )
    core_idea = models.CharField(
        max_length=40, blank=True, null=True, verbose_name=_("core idea")
    )
    task = models.TextField(
        max_length=400, blank=True, null=True, verbose_name=_("task")
    )
