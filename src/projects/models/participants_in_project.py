...
class ParticipantInProject(models.Model):
    project = models.ForeignKey(_("Actual project"),to="Project", on_delete=models.CASCADE)
    profile = models.ForeignKey(_("Participant profile"),to=Profile, on_delete=models.CASCADE)
    roles = models.ManyToManyField(_("Participant roles"),to="Role", through="RolesInProject")
    tools = models.ManyToManyField(_("Participant tools"),to="Tool", through="ToolsInProject")
